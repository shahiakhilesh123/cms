...
class YesAwayApiController extends BaseApiController {
    ...
    public static function createBookingArray($data){
        $cars['pickup']= $data['pickup'];
        $cars['dropoff']= $data['dropoff'];
        $cars['pickup_location']= $data['pickup_location'];
        $cars['dropoff_location']= $data['dropoff_location'];
        $cars['start_date']= $data['start_date'];
        $cars['start_time']= $data['start_time'];
        $cars['end_date']= $data['end_date'];
        $cars['end_time']= $data['end_time'];
        $cars_data = json_decode($data['cars'], true);
        $cars['AirConditionInd'] = isset($cars_data['VehAvailCore']['Vehicle']['@attributes']['AirConditionInd']) ? $cars_data['VehAvailCore']['Vehicle']['@attributes']['AirConditionInd'] : '';
        $cars['VehicleCategory'] = isset($cars_data['VehAvailCore']['Vehicle']['VehType']['@attributes']['VehicleCategory']) ? $cars_data['VehAvailCore']['Vehicle']['VehType']['@attributes']['VehicleCategory'] : '';
        $cars['Size'] = isset($cars_data['VehAvailCore']['Vehicle']['VehClass']['@attributes']['Size']) ? $cars_data['VehAvailCore']['Vehicle']['VehClass']['@attributes']['Size'] : '';
        $cars['Code'] = isset($cars_data['VehAvailCore']['Vehicle']['VehMakeModel']['@attributes']['Code']) ? $cars_data['VehAvailCore']['Vehicle']['VehMakeModel']['@attributes']['Code'] : '';
        $cars['TransmissionType'] = isset($cars_data['VehAvailCore']['Vehicle']['@attributes']['TransmissionType']) ? $cars_data['VehAvailCore']['Vehicle']['@attributes']['TransmissionType'] : "";
        $cars['VehGroupID'] = isset($cars_data['VehAvailCore']['Vehicle']['VehMakeModel']['@attributes']['VehGroupID']) ? $cars_data['VehAvailCore']['Vehicle']['VehMakeModel']['@attributes']['VehGroupID'] : '';  
        $cars['company_name']= $cars_data['company_name'];
        $cars['api_url_code']= $cars_data['api_url_code'];
        $cars['currency'] = session()->get('currency_name');
        $cars['vehicle_actual_currency'] = $cars_data['vehicle_price_currency'];
        $cars['vehicle_price']=  $cars_data['vehicle_price'];
        $cars['vehicle_actual_price']=  $cars_data['vehicle_actual_price'];
        $cars['vehicle_name'] =  $cars_data['vehicle_name'];
        $cars['vendor_id'] =  $cars_data['vendor_id'];
        return $cars;
    }
...
//                Utility::sendTestEmail($data);
    ...
    private static function formatVehiclesForLocationData($data, $vendor_id) {
        if(isset($data['OTA_VehAvailRateMoreRS']['VehAvailRSCore']['VehVendorAvails']['VehVendorAvail']['VehAvails']['VehAvail']) && is_array($data['OTA_VehAvailRateMoreRS']['VehAvailRSCore']['VehVendorAvails']['VehVendorAvail']['VehAvails']['VehAvail']) && !empty($data['OTA_VehAvailRateMoreRS']['VehAvailRSCore']['VehVendorAvails']['VehVendorAvail']['VehAvails']['VehAvail'])) {            
            ...
            $commission = \App\Http\Controllers\Api\BaseApiController::getCommission($vendor_id);
