...
class EasirentApiController extends BaseApiController {
    ...
    public static function createBookingArray($data){
      $cars['start_date'] = $data['start_date']; //2023-04-28
      $cars['end_date'] = $data['end_date']; // 2023-04-28
      $cars['start_time'] = $data['start_time']; // 10:00
      $cars['end_time'] =  $data['end_time']; // 10:00
      $cars['pickup']= $data['pickup'];
      $cars['dropoff']= $data['dropoff'];
      $cars_data = json_decode($data['cars'], true);
      $cars['hiredays'] = $cars_data['hiredays'];
      $cars['vehicle_id'] = isset($cars_data['id']) ? $cars_data['id'] : '';
      $cars['group']= isset($cars_data['group']) ? $cars_data['group'] : '';
