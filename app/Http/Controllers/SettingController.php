...
class SettingController extends Controller
{
    ...
    public function saveSetting(Request $request)
    {
        ...
        Setting::where('id', 1)->update([
            ...
            'secound_row_first_title' => $request->secound_first_title,
            'secound_row_first_file' => $request->secound_row_first_file,
            'secound_row_first_link' => $request->secound_row_first_link,
