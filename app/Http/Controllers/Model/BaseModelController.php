...
class BaseModelController {
    ...
    public static function getMenu($menu_id = 0){
        return \App\Models\MenuModel::where('menu_id', $menu_id)->where('status', '1')->get()->toArray();
    }
    public static function getMenuByLink($link){
        return \App\Models\MenuModel::where('menu_link', $link)->where('status', '1')->get()->toArray();
    }
