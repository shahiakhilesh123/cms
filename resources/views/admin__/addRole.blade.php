                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check">
                          <input class="form-check-input" type="checkbox" value="{{ $menu['id'] }}" checked="">
                          <label class="form-check-label">{{ $menu['menu_name'] }}</label>
                          <?php $submenus = App\Models\MenuModel::where('menu_id',$menu['id'])->orderBy('menu_name','asc')->get()->toArray(); 
                          foreach($submenus as $submenu){ ?>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="{{ $submenu['id'] }}" checked="">
